...
namespace MyHTTPServer
{
    ...
    public class HttpProcessor
    {
        ...
        private string streamReadLine(Stream inputStream)       //只读一行
        {
            int next_char;
            string data = "";
            while (true)
        ...
        public void handlePOSTRequest()
        {
            ...
            Encoding myEncoding = Encoding.GetEncoding("Unicode");
            if (this.httpHeaders.ContainsKey("Content-Length"))
            {
                ...
                while (to_read > 0)
                {
                    ...
                    to_read -= numread;
                    ms.Write(buf, 0, numread);    //把客户端传来的数据变成字符流
                }
                //打印 data
                //string data = myEncoding.GetString(buf);
                //Console.WriteLine(data);
                ms.Seek(0, SeekOrigin.Begin);
            }
            Console.WriteLine("get post data end");
            srv.handlePOSTRequest(this, new StreamReader(ms,Encoding.Unicode));
        }
    ...
    public class MyHttpServer : HttpServer
    {
        ...
        public override void handlePOSTRequest(HttpProcessor p, string inputData)
        {
            Console.WriteLine("POST request: {0}", p.http_url);
            ...
            p.outputStream.WriteLine("{0}", inputData);
